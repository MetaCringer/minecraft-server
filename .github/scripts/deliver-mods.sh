...
ssh -i key.pem -o UserKnownHostsFile=~/.ssh/known_hosts ${USER_DELIVERY}@${HOST_DELIVERY} "cd ${PATH_DELIVERY}/app/mods && rm -rf ${PATH_DELIVERY}/app/mods/* && tar -xvf ${PATH_DELIVERY}/mods.tar.gz && rm -f ${PATH_DELIVERY}/mods.tar.gz"
